        ...
        return this.each(function() {
            ...
            var tabSwitch = function(selectedItem, previousItem) {
                ...
                if (selectedItem >= menuItemCount || selectedItem < 0) {
                     ...
                     */
                    menuItem.eq(previousItem).removeClass('activo').attr('aria-hidden', 'true');
                    menuItem.eq(selectedItem).addClass('activo').attr('aria-hidden', 'false');


                    /*
                     * Add active class to current tab content item
                     */
                    contentItem.eq(previousItem).removeClass('activo').attr('aria-hidden', 'true');
                    contentItem.eq(selectedItem).addClass('activo').attr('aria-hidden', 'false');
             ...
             * Set startslide
             */
            menuItem.attr('aria-hidden', 'true').eq(previousIndex).addClass('activo').attr('aria-hidden', 'false');
            contentItem.attr('aria-hidden', 'true').eq(previousIndex).addClass('activo').attr('aria-hidden', 'false').css('display', 'block');
